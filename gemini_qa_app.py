...
st.title('Langchain Demo With Gemini')                  # heading of the website
input_text=st.text_input("Enter your question here")        # takes input from user
...
# To run this code - streamlit run gemini_qa_app.py